...
app.get("/svelte-logo.png", (req, response) => response.sendFile(path.join(__dirname, "../docs/svelte-logo.png")));
//app.get("/slides", (req, response) => response.sendFile(path.join(__dirname, "../graphql-texas-slides/dist/index.html")));
//app.get("/deck.js", (req, response) => response.sendFile(path.join(__dirname, "../graphql-texas-slides/dist/deck.js")));
// app.get("/docup.min.css", (req, response) => response.sendFile(path.join(__dirname, "../docs/docup.min.css")));
// app.get("/overrides.css", (req, response) => response.sendFile(path.join(__dirname, "../docs/overrides.css")));
// app.get("/docup.min.js", (req, response) => response.sendFile(path.join(__dirname, "../docs/docup.min.js")));
